        ...
        if (pathParts.length >= 1) {
          ...
          if (country) {
            ...
            if (pathParts.length >= 2) {
              ...
              // Country page - use capital city or first city
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      ...
      <Button
        ...
        className="w-14 h-14 rounded-full bg-green-600 hover:bg-green-700 shadow-lg transition-all duration-300 hover:scale-110 group"
        size="icon"
      >
      ...
      <Button
        ...
        className="w-14 h-14 rounded-full bg-green-500 hover:bg-green-600 shadow-lg transition-all duration-300 hover:scale-110 group"
        size="icon"
      >
