...
export default function ServiceContactButtons({ city }: ServiceContactButtonsProps) {
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4 mb-8">
      {/* Call Now Button - No changes needed here, it's clear */}
      <Button asChild className="bg-green-600 hover:bg-green-700 text-white px-6 py-6 text-lg w-full sm:w-auto">
      ...
      {/* --- FIX: WhatsApp button now has a default background for better contrast --- */}
      <Button asChild variant="outline" className="border-white/30 bg-white/10 text-white hover:bg-white/20 px-6 py-6 text-lg w-full sm:w-auto">
