...
export const services: Service[] = [
  {
    ...
    description: '24/7 emergency plumbing services for leaks and clogs.',
...
export const coverageData: CoverageData = {
  'sa-1': ['الملز', 'العليا', 'النسيم', 'الروضة'], // Riyadh
  'ae-1': ['ديرة', 'جميرا', 'البرشاء', 'دبي مارينا'], // Dubai
  'ae-2': ['جزيرة الريم', 'الخالدية', 'المشرف'], // Abu Dhabi
};
